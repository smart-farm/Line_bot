...
//for($i = 0; $i<count($checkloop);$i++) {
  ...
  $arrayPostData['messages'][0]['text'] ="แจ้งสมาชิกเรื่อง การเข้าใช้บริการแอพอีซีรอตโต้
============
เพื่อความเป็นระเบียบเรียบร้อยในการบริหารจัดการระบบ และเพื่อความปลอดภัยของสมาชิกเอง ทางทีมงานจึงขอระงับการให้บริการห้องฟรีนี้ (วันที่ 11/11/2018 เวลา 16.00 น.) และขอเชิญท่านเข้าใช้งานห้อง VIP แบบฟรี!! โดยเรามีเงื่อนไขดังนี้

1. ท่านต้องสมัครผ่านลิงค์ของเราก่อนถึงเข้าใช้งานได้
...
5. แคปหน้าจอหลักฐานการเติมเงิน แล้วส่งมาที่ Line ID : ohopc หรือ tor_nvidia-amd
6. แจ้งเบอร์ของท่านกับแอตมิน เพื่อเปิดโปรแกรมอีซีรอตโต้
7. หากเครดิตท่านไม่เดินเป็นเวลานาน ทางทีมงานขออนุญาตเชิญออก

ทั้งนี้สมาชิกแบบ VIP แบบฟรี มีสิทธิทุกประการเทียบเท่าห้อง VIP รายเดือน หรือหากท่านต้องการเปลี่ยนจาก VIP แบบฟรี เป็นห้อง VIP รายเดือน ติดต่อเราได้ที่ Line ID : ohopc หรือ tor_nvidia-amd

ขออภัยในความไม่สะดวก";

  /*"แจ้งสมาชิก เรื่องการส่งเลขแบบพิเศษ
----------------------
