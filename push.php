...
//for($i = 0; $i<count($checkloop);$i++) {
  ...
  $arrayPostData['messages'][0]['text'] ="การเข้าใช้บริการ แอพอีซีรอตโต้
============
1.ห้อง VIP 350 บ./ด.
- ได้ ปัก รูด วิน เสียว ไหล คำนวณสด
- ได้เลข หวยหุ้นทั่วโลก หวยรัฐบาล
- ได้เลขยี่กี เจสทุกห้อง และพันรอตโต้
- ได้ใช้ โปรแกรมคำนวณยี่กี/เลขไหล
- สมัครสมาชิก VIP : http://bit.ly/register_vip
- จากนั้นล็อคอิน จะพบเมนู "แจ้งโอนเงิน"
- เราจะดึงเข้าห้อง เมื่อได้รับยอดเงินแล้ว

2.ห้อง VIP 350 บ./ด. แบบฟรี!!
- สมัครที่นี่ : http://bit.ly/membervip_free
- สมัครเจสด้วย ชื่อใหม่/เบอร์เดิม/บช.เดิม
- เติมเงิน/แคปจอภาพ ส่งมาที่ ohopc หรือ tor_nvidia-amd
- หากเครดิตไม่เดิน 7 วัน เชิญออก";
